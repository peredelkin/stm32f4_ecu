...
#define COIL_TDC_ANGLE_1 20753
#define COIL_TDC_ANGLE_2 32768

#define COIL_0_OFFSET_ANGLE (uint16_t)COIL_TDC_ANGLE_1
#define COIL_0_GPIO GPIOD
#define COIL_0_BSRR_MASK GPIO_ODR_ODR_13 //оранжевый

#define COIL_1_OFFSET_ANGLE (uint16_t)(COIL_TDC_ANGLE_1+COIL_TDC_ANGLE_2)
#define COIL_1_GPIO GPIOD
#define COIL_1_BSRR_MASK GPIO_ODR_ODR_14 //красный

#define COIL_2_OFFSET_ANGLE (uint16_t)(COIL_TDC_ANGLE_1+COIL_TDC_ANGLE_2)
#define COIL_2_GPIO GPIOD
#define COIL_2_BSRR_MASK GPIO_ODR_ODR_12 //зеленый

#define COIL_3_OFFSET_ANGLE (uint16_t)(COIL_TDC_ANGLE_1)
